...
## How to run
Open the notebooks [IMDB_Movie_Rating_Prediction_Pipeline.ipynb](https://github.com/chrisandrachristopher12-max/IMDB-Movie-Rating-Predictions-Group-10/blob/main/IMDB_Movie_Rating_Prediction%20Pipeline.ipynb).  Click "Open in Colab" button. The link direct to Google Colab.
